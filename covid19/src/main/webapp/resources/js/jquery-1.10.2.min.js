...
$(function(){
	...
	$("#btnSubmit").click(function(){$.ajax({type:"POST",url:"/assets/php/notify.php",data:$("#frmnotify").serialize(),success:function(a){$("#submitMessage").html("Please Wait...");if(parseInt(a)>0){$("#submitMessage").html('<div class="alert-success"><strong>Done! </strong> Successfully submitted</div>')}else{alert(a);$("#submitMessage").html('<div class="alert-error"><strong>Error! </strong> Somthing is Wrong!</div>')}}})});
	$("#wdSubmit").click(function(){$.ajax({type:"POST",url:"/assets/php/worldtry.php",data:$("#worldtry").serialize(),success:function(a){$("#worldtry #submitMessage").html("Please Wait...");if(parseInt(a)>0){$("#worldtry #submitMessage").html('<div class="alert-success"><strong>Done! </strong> Successfully submitted</div>')}else{alert(a);$("#worldtry #submitMessage").html('<div class="alert-error"><strong>Error! </strong> Somthing is Wrong!</div>')}}})})
});
